        ...
        children: [
          ...
          if (settings.showHindi && hasHindi) ...[
            ...
            Text(verse.transliterationHi!,
                ...
                style: TextStyle(fontSize: settings.fontSizeHindi, color: gurmukhiColor ?? Colors.red.shade900)),
          ],
          if (settings.showTransliteration && hasTranslit) ...[
            const SizedBox(height: 4),
            Text(verse.transliteration!,
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: settings.fontSizeEnglish, color: gurmukhiColor?.withAlpha(180) ?? Colors.blueGrey)),
          ],
          ...
          if (settings.showPunjabiMeaning && hasPunjabiMeaning) ...[
            ...
            Text(verse.translationPa!,
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: settings.fontSizePunjabiMeaning, color: gurmukhiColor ?? Colors.teal.shade900)),
          ],
        ],
      ),
    );
